...
parser.add_argument("--exo", type=str, default="umi_so100", choices=list(EXOSKELETON_CONFIGS.keys()), help="Exoskeleton configuration to use")
...
while True:
    ...
    try: link_poses, camera_pose_world, cam_K_, corners_cache,corners_vis,obj_img_pts = detect_and_set_link_poses(rgb, model, data, robot_config,cam_K=cam_K)
    except: 
