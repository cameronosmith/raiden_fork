...
from ExoConfigs import EXOSKELETON_CONFIGS, UMI_SO100_CONFIG
...
UMI_SO100_CONFIG.exo_link_alpha = 0
robot_config = UMI_SO100_CONFIG#EXOSKELETON_CONFIGS[args.exo]
